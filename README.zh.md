...
### [我的博客在这里 &rarr;](http://shengdexiang.github.io)
...
```
# Site settings
title: S.D.X. Blog             # 你的博客网站标题
SEOTitle: S.D.X. Blog			# 在后面会详细谈到
...
我的博客标题是 **“S.D.X. Blog”** 但是我想要在搜索的时候显示 **“S.D.X.的博客 | S.D.X. Blog”** ，这个就需要SEO Title来定义了。
